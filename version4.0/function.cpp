...
void editInfo(int option, string temp,Info *nowptr){
    ...
    case 3:
        ...
        break;
    case 4:
        if (atoi(temp.c_str()) < 20 || atoi(temp.c_str()) >65){
            cout << "-------------------------------" << endl;
            cout << "|          input error         " << endl;
            cout << "-------------------------------" << endl;
            exit(0);
        }
        nowptr->information.age = atoi(temp.c_str());
        break;
    case 5:
        if (atoi(temp.c_str()) < 5000 || atoi(temp.c_str()) > 100000){
            cout << "-------------------------------" << endl;
            cout << "|          input error         " << endl;
            cout << "-------------------------------" << endl;
            exit(0);
...
void Person::Update(int option, string temp){
...
void Person::regist(Info *newptr){
    ...
    cout << "         NULL HD TD ED         " << endl;
    cout << "-------------------------------" << endl;
    cin >> section;
    while (section != "HD" && section != "HD" && section != "ED" && section != "NULL"){
        cout << "-------------------------------" << endl;
        cout << "           input error         " << endl;
        cout << "       input your section      " << endl;
        cout << "-------------------------------" << endl;
...
void Worker::Update(int option, string temp){
    switch (option){
    case 1:
        this->name=temp;
        break;
...
void Manager::Add(Info *ptr, Info *pptr){
    ...
    double wage;
    bool flag=true;
    string password,name,type,sex,section;
    cout << "-------------------------------" << endl;
...
void Manager::Update(int option, string temp){
    switch (option){
    case 1:
        this->name = temp;
        break;
